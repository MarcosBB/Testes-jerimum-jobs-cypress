...
class CandidatoCreationForm{
  elements = {
    ...
    checkUseTerm: () => cy.get('.icheck').first(),
  ...
  createUser({
    ...
    this.elements.submitButton().click({ force: true , multiple: true})
  }
...
describe('Form de criação de usuário admin', () => {
  ...
  it('Criação de usuário admin', () => {
    ...
    cy.get('.alert-success').should('contain.text', 'Seu cadastro foi realizado com sucesso!')
  })
